...
export default function DownloadsSection({ items }: { items: DownloadItem[] }) {
  ...
  return (
    ...
    <section
      id="downloads"
      className="bg-green pt-[7.153vw] pb-[11.458vw] max-md:py-14"
    ...
    >
      <div className="pl-[18.542vw] pr-[2.431vw] max-md:px-5">
        ...
        <div className="mt-[3.333vw] flex flex-wrap gap-[0.972vw] max-md:mt-8 max-md:gap-3">
          {items.map((item) => (
            <a
              key={item.titel}
              href={item.url}
